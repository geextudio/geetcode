package io.geextudio.jmixtudio.test_support;

import io.geextudio.jmixtudio.JmixtudioApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "io.geextudio.jmixtudio.screen")
@ContextConfiguration(classes = {JmixtudioApplication.class, UiTestAssistConfiguration.class})
